      ...
      <div className="container">
        ...
        <div className="advantages">
          ...
          <p className="advantage bleu">
            <strong>
              <span>
                Un site de souscription dédié pour vos souscriptions
                d'assurances personnelles.
              </span>
            </strong>
            <br />
            <br /> Une assurance voyage réservée aux professionnels du tourisme,
            pour y avoir accès contacter votre commercial ou notre service
            client.
          </p>
          <p className="advantage bleu">
            <strong>
        ...
        <p className="contact">
          ...
          voyage de Assurever ? <br /> Contacter notre équipe commerciale par
          mail
        ...
        <div className="gammepro">
          ...
          <p>
            Cette gamme est destinée aux professionnels du tourisme. Elle
            comprend bien sur la RCP (Responsabilité Civile Professionnelle)
            mais également la multirsique pour vos locaux, la santé prévoyance,
