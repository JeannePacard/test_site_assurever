      ...
      <div className="hero">
        <div className="left-part">
          ...
          <p>
            ...
            tourisme, sur les marchés loisirs et affaires, pour les individuels
            et les groupes. <br />
            Précédemment faisant partie du groupe APRIL,la société a été reprise
            par ses dirigeants en décembre 2019.
          </p>
        </div>
      ...
      <div className="about-us">
        ...
        <div className="about-us__container">
          ...
          <p>
            ...
            consectetur adipisicing elit. Aut laborum libero quia corrupti illo,
            voluptatibus expedita modi maxime quam odit, tenetur eum voluptates
            deleniti non voluptatem. Itaque recusandae illum veniam soluta nisi
            asperiores rem voluptates repellendus dolores nobis. Earum doloribus
            similique animi accusamus, voluptates quas explicabo recusandae
            nesciunt rem maxime nobis in quibusdam quo commodi, totam tempora
            beatae reiciendis quia voluptatibus inventore vitae, blanditiis vero
            sapiente. Minus, magnam laudantium? Alias mollitia enim ea ipsam
            eveniet libero error quam soluta deleniti. Obcaecati animi, impedit
            architecto quasi pariatur amet fugiat! Aliquam fuga corporis saepe
            aperiam dicta et autem sint repudiandae molestias quod.
          </p>
        </div>
      </div>
      <hr />
